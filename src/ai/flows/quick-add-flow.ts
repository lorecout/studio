...
const prompt = ai.definePrompt({
  ...
  prompt: `
    ...
    **Instruções:**
    1. Leia o texto e identifique cada transação individual. Elas podem estar separadas por linhas, vírgulas ou outras pontuações.
    2. Para cada transação, extraia a descrição, o valor, a categoria e o tipo.
    ...
    7. Retorne um array de objetos de transação. Se nenhuma transação for encontrada, retorne um array vazio.
